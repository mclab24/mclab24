...
| **Status** | ✅ Abgeschlossen |
| **Datum** | 04.07.2026 |
| **Hinweis** | ✅ Migration abgeschlossen |
...
## ✅ Phase 9: Visual Studio Code Konfiguration
...
| Kategorie | Extensions | Beschreibung |
|-----------|------------|--------------|
| **Programmierung** | C/C++ (Microsoft), C++ IntelliSense | C/C++ Support |
| **Web-Entwicklung** | HTML CSS Support, HTML Preview, PHP Intelephense, JavaScript (ES6) | Web-Technologien |
| **Datenformate** | JSON Crack Editor, YAML | JSON/YAML Bearbeitung |
| **Arduino/ESP32** | Arduino, ESP32 FS loader, PlatformIO IDE for VSCode | Hardware-Programmierung |
| **AI-Assistenz** | GitHub Copilot, GitHub Copilot Chat | KI-gestützte Entwicklung |
| **Git** | GitLens, Git History | Git-Integration |

### Einstellungen & Best Practices

- **Encoding:** UTF-8 (ohne BOM)
- **End of Line:** LF für Linux-Kompatibilität
- **Tabs:** Spaces für konsistente Formatierung
- **Word Wrap:** Aktiviert für bessere Lesbarkeit

### Git/GitHub Integration

- ✅ GitLens für erweiterte Git-Funktionen
- ✅ GitHub Copilot für Code-Vorschläge
- ✅ SSH-Authentifizierung konfiguriert
- ✅ Remote-Branches sichtbar

---

## ✅ Phase 10: Arduino IDE & ESP32 Setup
...
Arduino IDE Version 2.x installiert und konfiguriert.

### ESP32 Board-Support

- ✅ ESP32 Board-Support über Board-Verwalter hinzugefügt
- ✅ Bibliotheken installiert: WiFi, ESPAsyncTCP, AsyncTCP

### Wemos D1 R32 Konfiguration
...
**Datei:** `D:\VisualStudioCode\Projekte\mclab24\mclab24\projekte\code-projekte\esp32-test\esp32-test.ino`
...
| Upload auf ESP32 | ✅ Erfolgreich |
| Serielle Ausgabe | ✅ "Hallo vom ESP32 / Wemos D1 R32 - mclab24!" |
| Serielle Kommunikation (115200 Baud) | ✅ Stabil |

---

## ✅ Phase 11: SSH-Git-Integration für mclab24
...
```powershell
ssh-keygen -t ed25519 -C "mclab24-github" -f "$env:USERPROFILE\.ssh\mclab24-github"
```

### SSH-Config Konfiguration

```ssh-config
Host github.com-mclab24
    HostName github.com
    User git
    IdentityFile ~/.ssh/mclab24-github
    IdentitiesOnly yes
```
...
```bash
git remote set-url origin git@github.com-mclab24:mclab24/mclab24.git
```

### SSH-Test erfolgreich durchgeführt

```
PS D:\VisualStudioCode\Projekte\mclab24\mclab24> ssh -T git@github.com-mclab24
Hi mclab24! You've successfully authenticated...
```

### Git Push über SSH

```powershell
PS D:\VisualStudioCode\Projekte\mclab24\mclab24> git push
Everything up-to-date
```

### UTF-8 BOM Lösung

**Problem:** SSH-Config enthielt UTF-8 BOM, was zu Verbindungsfehlern führte.

**Lösung:** Datei mit Notepad++ als "UTF-8 ohne BOM" neu gespeichert.

```powershell
Get-Content ~/.ssh/config | Set-Content -Encoding utf8NoBOM ~/.ssh/config
```

---

## ✅ Phase 12: Entwicklungsworkflow
...
mclab24/
├── projekte/
│   ├── web-projekte/          # Web-Anwendungen
│   │   └── [projekt-name]/
│   │       ├── index.html
│   │       ├── styles.css
│   │       └── app.js
│   └── code-projekte/         # Hardware/Embedded
│       └── esp32-test/
│           └── esp32-test.ino
...
|-----|--------------|----------|
| `feat:` | Neues Feature | `feat: ESP32 WLAN-Anbindung` |
| `fix:` | Fehlerbehebung | `fix: SSH Authentifizierung` |
| `docs:` | Dokumentation | `docs: Deployment-Anleitung` |
| `refactor:` | Code-Refactoring | `refactor: Deploy-Script` |
| `test:` | Tests | `test: Webhook End-to-End` |
...
| **Branches** | Aussagekräftige Branch-Namen |
| **Dateien** | UTF-8 ohne BOM für alle Textdateien |
| **ESP32** | 115200 Baud für serielle Kommunikation |
| **Git** | Regelmäßig push/pull durchführen |
| **SSH** | Ed25519 Keys bevorzugen |
...
|-----------|---------|--------|-------|
| **deploy.sh** | 2.0.0 | ✅ Aktiv | 02.07.2026 |
| **webhook.php** | 2.0.0 | ✅ Aktiv | 02.07.2026 |
| **deploy.config** | 2.0.0 | ✅ Aktiv | 02.07.2026 |
| **Apache vHosts** | 1.0.0 | ✅ Läuft | 02.07.2026 |
| **VSCode Setup** | 1.0.0 | ✅ Aktiv | 04.07.2026 |
| **ESP32 Testsketch** | 1.0.0 | ✅ Aktiv | 04.07.2026 |
| **SSH-Integration** | 1.0.0 | ✅ Aktiv | 04.07.2026 |
...
|---------|-------------|--------|
| **2.1.0** | VSCode, Arduino, ESP32, SSH | ✅ Abgeschlossen |
| **2.2.0** | co-treff Integration | 📋 Geplant |
| **2.3.0** | mprojektede Integration | 📋 Geplant |
...
| Phase 8 | Multi-Repo Deploy-System v2.0.0 | ✅ Abgeschlossen |
| Phase 9 | Visual Studio Code Konfiguration | ✅ Abgeschlossen |
| Phase 10 | Arduino IDE & ESP32 Setup | ✅ Abgeschlossen |
| Phase 11 | SSH-Git-Integration für mclab24 | ✅ Abgeschlossen |
| Phase 12 | Entwicklungsworkflow | ✅ Abgeschlossen |
...
| Hardware | Arduino / ESP32 / Wemos D1 R32 |
| Hosting | Netcup |

### Nächste Schritte

1. **ESP32/Wemos D1 R32 Projekte entwickeln**
   - WLAN-Funktionalität integrieren
   - Sensorik anbinden
   - IoT-Konzepte umsetzen
...
**Dokumentation erstellt:** 04.07.2026  
**Version:** 2.1.0  
**Status:** ✅ Aktuell
